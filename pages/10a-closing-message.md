...
<div class="text-base leading-snug text-[#AAB1C7] opacity-70 mb-4" v-click>천재처럼 어려운 코드를 짜는 것이 아니라</div>
...
<div class="mt-6 p-4 border-l-4 border-[#F96167] bg-white/5 max-w-2xl" v-click>
