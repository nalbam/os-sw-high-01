...
<img src="./images/vibemon.jpg" class="w-full h-auto" />
</div>
</div>
...
<div class="text-3xl leading-snug font-semibold text-[#2A2D43] mt-10 mb-4">검은 글자 화면(터미널)을 계속 보고 있지 않아도<br/><span class="text-[#F96167]">상태를 알 수는 없을까?</span></div>
...
<div class="mt-6 p-5 border-l-4 border-[#F96167] bg-white/5" v-click.scale>
