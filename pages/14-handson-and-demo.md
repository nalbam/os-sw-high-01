...
<div class="text-xl font-semibold text-white">"내가 자주 불편한 것 한 가지 — 한 줄"</div>
</div>

<div class="grid grid-cols-3 gap-3 mt-5">
<div class="bg-white/5 border border-[#AAB1C7]/20 p-3 rounded">
<div class="text-xs uppercase tracking-widest text-[#CADCFC] font-mono mb-1">예시 1</div>
<div class="text-xs text-[#CADCFC]">"수행평가 마감일을 자꾸 까먹는다"</div>
</div>
<div class="bg-white/5 border border-[#AAB1C7]/20 p-3 rounded">
...
<div class="mt-5 text-center text-sm text-[#AAB1C7] font-mono">시간 · 약 5분</div>
...
<div class="text-2xl font-bold text-[#1A1A2E] leading-snug">"내가 자주 불편한 것 한 가지<br/>— 한 줄"</div>
</div>
...
<div class="bg-[#1A1A2E] text-white p-3 rounded text-center">이름 안 적어도 OK</div>
<div class="bg-[#1A1A2E] text-white p-3 rounded text-center">한 줄로 충분</div>
<div class="bg-[#1A1A2E] text-white p-3 rounded text-center">정답 없음</div>
</div>
...
<div class="text-3xl mt-2 mb-6 font-bold text-white">여러분 아이디어 중 하나를<br/><span class="text-[#F96167]">— 지금 만들어 봅니다</span></div>
...
<div class="text-2xl text-[#6B6E80] mb-4">아이디어 한 줄에서 시작했고</div>
...
<div class="text-xs uppercase tracking-widest text-[#F96167] font-mono mb-2">한 줄</div>
<div class="text-sm text-[#2A2D43]">불편한 것을 한 줄로</div>
</div>
<div class="bg-white p-5 rounded shadow-sm border-t-4 border-[#F96167]">
...
<div class="text-base">여러분도 — <span class="text-[#F96167] font-semibold">시작은 한 줄</span>이면 충분합니다</div>
</div>
